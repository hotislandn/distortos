...
set(DISTORTOS_RAW_LINKER_SCRIPT "source/board/VIRT_RV32IMC/VIRT_RV32IMC.ld")
...
distortosSetFixedConfiguration(BOOLEAN
	DISTORTOS_ARCHITECTURE_RISCV
		ON)

distortosSetFixedConfiguration(BOOLEAN
	DISTORTOS_ARCHITECTURE_RV32
		ON)

distortosSetFixedConfiguration(BOOLEAN
	DISTORTOS_ARCHITECTURE_RISCV_RV32IMC
		ON)
...
# override
distortosSetConfiguration(INTEGER
		distortos_Scheduler_04_Main_thread_stack_size_rv
		4096
...
include("${CMAKE_CURRENT_SOURCE_DIR}/source/architecture/RISCV/RV32/distortos-sources.cmake")
