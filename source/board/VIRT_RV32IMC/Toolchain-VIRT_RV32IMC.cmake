#
# file: Toolchain-VIRT_RV32IMC.cmake
#
...
if(SOURCE_BOARD_VIRT_RV32IMC_TOOLCHAIN_VIRT_RV32IMC_CMAKE_)
	return()
endif()
set(SOURCE_BOARD_VIRT_RV32IMC_TOOLCHAIN_VIRT_RV32IMC_CMAKE_ 1)
...
set(CMAKE_ASM_FLAGS "-x assembler-with-cpp -march=rv32imac_zicsr_zifencei_zicntr -mabi=ilp32 -D__ASSEMBLY__ ")

# rv32imac_zicsr_zifencei_zicntr i-fno-omit-frame-pointer
set(CMAKE_C_FLAGS
		"-ffunction-sections -fdata-sections -Wall -Wextra -Wshadow -march=rv32imac_zicsr_zifencei_zicntr -mabi=ilp32 "
		CACHE STRING "Flags used by the C compiler during all build types.")
set(CMAKE_CXX_FLAGS
		"-fno-rtti -fno-exceptions -ffunction-sections -fdata-sections -Wall -Wextra -Wshadow -Wno-psabi -march=rv32imac_zicsr_zifencei_zicntr -mabi=ilp32 "
...
distortosRemoveFlag(CMAKE_C_FLAGS "-mabi")
distortosRemoveFlag(CMAKE_CXX_FLAGS "-mabi")
distortosAddFlag(CMAKE_C_FLAGS "-mabi=${distortos_Build_02_Floating_point_ABI}")
distortosAddFlag(CMAKE_CXX_FLAGS "-mabi=${distortos_Build_02_Floating_point_ABI}")
...
set(DISTORTOS_BOARD_PATH "source/board/VIRT_RV32IMC")
